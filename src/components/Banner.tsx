    ...
    <div className="grid grid-cols-3 bg-blue-400 p-10 min-h-[70vh] gap-10">
      <div className="col-span-2 self-center flex flex-col gap-5">
        ...
        <p className="text-white">
          ...
          vaccination. By getting vaccinated, you're not just shielding yourself
          from diseases, but also safeguarding your community. Our experts are
          here to ensure you receive top-notch, safe vaccinations. Act now,
          prioritize health, and book your vaccination.
        </p>
      </div>
